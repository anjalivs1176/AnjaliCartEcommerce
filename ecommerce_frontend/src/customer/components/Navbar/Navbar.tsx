...
const Navbar = () => {
  ...
  const userImage = authUser?.profileImage || undefined;
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 md:px-10 lg:px-20 h-[70px]">
          ...
          <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
            {token ? (
              ...
              >
                <Avatar sx={{ width: 32, height: 32 }} src={userImage}>
            ...
            >
              <Badge
                ...
                color="error"
                invisible={!token || wishlistCount === 0}
              >
            ...
            >
              <Badge
                ...
                color="error"
                invisible={!token || cartItemCount === 0}
              >
